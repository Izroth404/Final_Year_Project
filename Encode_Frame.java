...
public class Encode_Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jLabelSourceImage, javax.swing.GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE)
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabelSourceImage, javax.swing.GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(jLabelEmbedded, javax.swing.GroupLayout.DEFAULT_SIZE, 484, Short.MAX_VALUE)
        );
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if(EmbeddedImage == null){
            JOptionPane.showMessageDialog(this, "No Text Message has been Embedded","Nothing to save", JOptionPane.ERROR_MESSAGE);
        }
        else{
    ...
    private void jButtonEmbedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEmbedActionPerformed
        ...
        jLabelEmbedded.setIcon(new ImageIcon(fitimage(EmbeddedImage, jLabelSourceImage.getWidth(), jLabelSourceImage.getHeight())));
        this.validate();
    ...
    private void embeddedMessage(BufferedImage img, String mess){
        ...
        if(messageLength * 8 + 32> imageSize){
            JOptionPane.showMessageDialog(this, "Message to long for this image", "Message Too Long!", JOptionPane.ERROR_MESSAGE);
            return;
        }
        else{
    ...
    private void jButtonOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOpenActionPerformed
        ...
        try {
            ...
            jLabelSourceImage.setIcon(new ImageIcon(fitimage(sourceImage, jLabelSourceImage.getWidth(), jLabelSourceImage.getHeight())));
            this.validate();
        } catch (IOException ex) {
